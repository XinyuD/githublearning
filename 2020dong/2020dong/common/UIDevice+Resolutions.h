...
enum {
    ...
    UIDeviceResolution_iPhoneRetina58    = 6,    // iPhone x,xs,11pro Retina Display 5.8" (1125x2436px)
    UIDeviceResolution_iPhoneRetina65    = 7,    // iPhone xs max,11pro max Retina Display 6.5" (1242x2688px)
    UIDeviceResolution_iPhoneRetina61    = 8,    // iPhone xr Retina,11 Display 6.1" (828x1792px)
